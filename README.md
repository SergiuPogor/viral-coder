...
|-------|---------|------------|
| tokyo-night | ![tokyo-night](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-tokyo-night.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-tokyo-night.mp4) |
| dracula | ![dracula](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-dracula.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-dracula.mp4) |
| catppuccin | ![catppuccin](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-catppuccin.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-catppuccin.mp4) |
| github-dark | ![github-dark](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-github-dark.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-github-dark.mp4) |
| monokai-pro | ![monokai-pro](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-monokai-pro.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-monokai-pro.mp4) |
| one-dark | ![one-dark](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-one-dark.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-one-dark.mp4) |
| nord | ![nord](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-nord.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-nord.mp4) |
| gruvbox | ![gruvbox](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-gruvbox.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/theme-gruvbox.mp4) |

### 7 Languages

| Language | Hook | Preview | Full Video |
|----------|------|---------|------------|
| TypeScript | Async retry that saves prod at 3am | ![ts](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-typescript.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-typescript.mp4) |
| Python | One-liners that replace 50 lines | ![py](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-python.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-python.mp4) |
| Rust | Zero-copy parser, zero allocations | ![rs](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-rust.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-rust.mp4) |
| Go | Fan-out goroutines, 10x faster | ![go](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-go.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-go.mp4) |
| JavaScript | Most over-engineered FizzBuzz ever | ![js](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-javascript.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-javascript.mp4) |
| Python decorators | retry/memoize/rate_limit chained | ![py2](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-python2.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-python2.mp4) |
| SQL | Recursive CTE graph traversal | ![sql](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-sql.gif) | [▶ Watch](https://github.com/SergiuPogor/viral-coder/releases/download/v1.0.6-examples/lang-sql.mp4) |
